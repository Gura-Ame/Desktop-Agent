...
def test_extend_path_does_not_ask_user_and_eventually_succeeds():
    scripts = {
        ...
        "system": [
            '<|tool_call|>run_action("attempt 1")<|tool_call|>',
            '<|tool_call|>run_action("attempt 2")<|tool_call|>',
            '<|tool_call|>run_action("attempt 3")<|tool_call|>',
            '<|tool_call|>run_action("attempt 4")<|tool_call|>',
        ],
        "verify": [
            "STATUS: FAIL\nREASON: 還沒到位 1",
            "STATUS: FAIL\nREASON: 還沒到位 2",
...
def test_ladder_falls_through_to_ask_user_then_resets_state():
    scripts = {
        ...
        "system": [
            ...
            '<|tool_call|>run_action("attempt 3")<|tool_call|>',
            '<|tool_call|>run_action("attempt 4")<|tool_call|>',
            '<|tool_call|>run_action("after user hint")<|tool_call|>',
        ],
        "verify": [
            "STATUS: FAIL\nREASON: 還是不行 1",
            "STATUS: FAIL\nREASON: 還是不行 2",
