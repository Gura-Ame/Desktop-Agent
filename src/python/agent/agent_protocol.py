...
from agent.tool_permissions import PermissionManager, PermissionMode
...
class AgentWorkerBase:
    ...
    is_paused_for_permission: bool
    pending_permission_decision: Optional[str]
    max_think_limit: int
    ...
    def generate_prethink(self, context_prompt: str): ...
    def set_instant_input_enabled(self, enabled: bool): ...
    def _gate_physical_input(self, func_name: str, args: list, kwargs: dict, args_str: str) -> bool: ...
